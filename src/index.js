...
var execDebounce = debounce(function (filePath) {
    execute(filePath);
}, 500);
// 添加监听
function watch(fileName) {
    ...
    var watcher = fs.watch(fileName, null, function (e, f) { return __awaiter(_this, void 0, void 0, function () {
        var s, filePath, exist, index, stat, e_1, ext;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    s = f.split('.');
...
// 遍历文件夹
function forEachDir(fileName) {
    return __awaiter(this, void 0, void 0, function () {
        var stats, raw_1, isExclude, dir, _i, dir_1, d, p, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 1:
                    stats = _a.sent();
                    raw_1 = String.raw(__makeTemplateObject(["", ""], ["", ""]), fileName);
...
function inputWatchDir() {
    return inputLoop("请输入监听目录:", function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var exists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, existWatchDir(path)];
                    case 1:
                        exists = _a.sent();
                        if (exists !== true) {
...
function existWatchDir(dir) {
    ...
    var pArr = dir.map(function (d) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs.existsSync(d)];
                case 1: return [2 /*return*/, (_a.sent()) ? Promise.resolve() : Promise.reject(d)];
            }
        });
    }); });
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var configFileName, configFilePath, existsConfigFile, isUseOld, file, _a, wd, tp, te, existsWatchDir, e_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    ...
                    console.log("该预编译语言类型", type, "尚未配置！请重新输入，或配置该类型！");
                    return [4 /*yield*/, inputType()];
                case 8:
                    type = _b.sent();
                    _b.label = 9;
                case 9:
                    if (!!targetExtension) return [3 /*break*/, 11];
                    return [4 /*yield*/, input("请输入编译后的文件类型(默认: " + JSON.stringify(Template[type].targetExtension) + "):")];
                case 10:
                    targetExtension = (_b.sent()) || Template[type].targetExtension;
                    _b.label = 11;
                case 11:
                ...
                case 15:
                    ...
                    // 遍历目录
                    watchDir.forEach(function (w) { return forEachDir(w); });
                    // 保存设置
                ...
                case 17:
                    e_3 = _b.sent();
                    console.error("init try catch", e_3);
                    return [3 /*break*/, 18];
                case 18:
